...
if os.path.exists(tesseract_dest):
    for item in os.listdir(tesseract_dest):
        item_path = os.path.join(tesseract_dest, item)
        if os.path.isfile(item_path):
            print(f"  - {item}")
        else:
            print(f"  + {item}/")
            if item == "tessdata" and os.path.exists(item_path):
